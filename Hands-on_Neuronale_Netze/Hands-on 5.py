    ...
    def train(self, data, solution):        
        ...
        for i in range(iterations):
            for j in range(data.shape[0]):
                #Die Ausgaben für die einzelnen Schichten
                ...
                #Zunächst müssen die Fehler der einzelnen Schichten berechnet werden
                outputLayerError = 
                hiddenLayerError =                
                
                #Anschließend müssen die Unterschiede zu den Zielwerten bestimmt werden
                deltaOutputLayer = 
                deltaHiddenLayer = 
                
                #Zuletzt werden die Gewichte entsprechend der Lernrate und dem Delta angepasst
